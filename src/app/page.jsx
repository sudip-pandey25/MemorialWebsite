...
export default function Home() {
  return (
    <>
      ...
      <div className="px-4 md:px-6 lg:px-8 xl:px-12 py-12 bg-teal-800 flex flex-col h-[90vh] gap-4 ">
        <div className="text-4xl font-semibold font-Crimson text-white text-center ">
          Memorial Gallaries
        </div>
        <Collection />
        <div className="flex justify-end items-center px-3 cursor-pointer group">
          <p className="text-white underline font-Roboto group ">Show more </p>
