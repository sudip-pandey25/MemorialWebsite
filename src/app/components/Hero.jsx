...
const Hero = () => {
  return (
    <>
      <div className="hero-shape z-10">
        <div className="hero-1"></div>
        <div className="hero-2"></div>
      </div>
      <div className="relative z-20 bg-[url('/background.jpg')] h-[70vh] md:h-[75vh] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center rounded-3xl shadow-lg ">
        {/* title Section */}
        <div className="">
